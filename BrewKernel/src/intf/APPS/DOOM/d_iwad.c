...
char *D_FindIWAD(int mask, GameMission_t *mission)
{
    ...
    else
    {
        ...
        // If no IWAD found in directories, try the embedded DOOM.WAD
        if (result == NULL)
        {
            printf("No IWAD found in directories, trying embedded DOOM.WAD\n");
            result = "DOOM.WAD";
            *mission = doom;  // Default to Doom mission for embedded WAD
        }
    }
