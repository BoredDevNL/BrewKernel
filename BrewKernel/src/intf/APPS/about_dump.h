...
static void create_log_txt_file(void) {
    ...
    // Get CPU info
    char cpu_buffer[4096];
    get_cpu_info(cpu_buffer, sizeof(cpu_buffer));
    len = 0;
    ...
    // Get Memory info
    char mem_buffer[2048];
    get_memory_info(mem_buffer, sizeof(mem_buffer));
    len = 0;
    ...
    // Get PCI info
    char pci_buffer[8192];
    get_pci_info(pci_buffer, sizeof(pci_buffer));
    len = 0;
    ...
    // Get BIOS data
    char bios_buffer[2048];
    get_bios_data(bios_buffer, sizeof(bios_buffer));
    len = 0;
    ...
    // Get memory map
    char memmap_buffer[1024];
    get_memory_map_info(memmap_buffer, sizeof(memmap_buffer));
    len = 0;
    ...
    get_kernel_info(kernel_buffer, sizeof(kernel_buffer));
    len = 0;
